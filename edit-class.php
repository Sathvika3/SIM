...
{   ?>
                                                    ...
                                                    <div class="form-group has-success">
                                                       ...
                                                       <div class="form-group has-success">
                                                        ...
                                                        <div class="">
                                                            <input type="text" name="classnamenumeric" value="<?php echo htmlentities($result->ClassNameNumeric);?>" required="required" class="form-control" id="success">
                                                            <span class="help-block">Eg- 1st year,2nd year</span>
                                                        </div>
                                                    </div>
                                                     <div class="form-group has-success">
