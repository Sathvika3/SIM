<div class="left-sidebar bg-black-300 box-shadow ">
  ...
  <li class="has-children">
   ...
   <li class="has-children">
                                        <a href="#"><i class="fa fa-users"></i> <span>Faculty</span> <i class="fa fa-angle-right arrow"></i></a>
                                        <ul class="child-nav">
                                            <li><a href="add-faculty.php"><i class="fa fa-bars"></i> <span>Add Faculty</span></a></li> 
                                            <!-- <li><a href="<?php echo base_url ?>admin/?page=students/manage_student" class="nav-link nav-students_manage_student"></li> -->
                                            <li><a href="manage-faculty.php"><i class="fa fa fa-server"></i> <span>Manage Faculty</span></a></li>
                                    ...
                                    <li class="has-children">
                                        ...
                                        <ul class="child-nav">
                                            ...
                                            <!-- <li><a href="<?php ?>admin/?page=students/manage_student" class="nav-link nav-students_manage_student"></li> -->
...
<li class="has-children">
                                        ...
                                        <li><a href="info.php"><i class="fa fa fa-server"></i> <span> View Student Info</span></a></li>
