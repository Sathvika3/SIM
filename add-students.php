...
$status=1;
$sql="INSERT INTO  tblstudents(StudentName,RollId,StudentEmail,Gender,ClassId,DOB,FatherName,MotherName,ContactNumber,AltenateNumber,HomeAddress,Status) VALUES(:studentname,:roolid,:studentemail,:gender,:classid,:dob,:fname,:mname,:connum,:altconnum,:homeaddress,:status)";
...
<html lang="en">
    <head>
        ...
        <title>SIM Admin| Student Admission< </title>
...
{   ?>
<option value="<?php echo htmlentities($result->id); ?>"><?php echo htmlentities($result->ClassNameNumeric); ?>&nbsp; <?php echo htmlentities($result->ClassName); ?>&nbsp; Section-<?php echo htmlentities($result->Section); ?></option>
<?php }} ?>
</select>
</div>
</div>
...
<div class="col-sm-10">
<input type="text" name="mname" class="form-control" id="mname" required="required" autocomplete="off">
</div>
</div>
<div class="form-group">
