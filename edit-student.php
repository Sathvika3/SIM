...
$status=$_POST['status'];
$sql="update tblstudents set StudentName=:studentname,RollId=:roolid,StudentEmail=:studentemail,Gender=:gender,DOB=:dob,FatherName=:fname,MotherName=:mname,ContactNumber=:connum,AltenateNumber=:altconnum,HomeAddress=:homeaddress,Status=:status where StudentId=:stid ";
...
<html lang="en">
    <head>
        ...
        <title>SIM Admin| Edit Student </title>
...
$sql = "SELECT tblstudents.StudentName,tblstudents.RollId,tblstudents.RegDate,tblstudents.StudentId,tblstudents.Status,tblstudents.StudentEmail,tblstudents.Gender,tblstudents.DOB,tblstudents.FatherName,tblstudents.MotherName,tblstudents.ContactNumber,tblstudents.AltenateNumber,tblstudents.HomeAddress,tblclasses.ClassName,tblclasses.Section from tblstudents join tblclasses on tblclasses.id=tblstudents.ClassId where tblstudents.StudentId=:stid";
$query = $dbh->prepare($sql);
$query->bindParam(':stid',$stid,PDO::PARAM_STR);
$query->execute();
...
<div class="col-sm-10">
<input type="text" name="fname" class="form-control" id="fname" value="<?php echo htmlentities($result->FatherName)?>"required="required" autocomplete="off">
</div>
</div>
...
<div class="col-sm-10">
<input type="text" name="mname" class="form-control" id="mname"value="<?php echo htmlentities($result->MotherName)?>" required="required" autocomplete="off">
</div>
</div>
<div class="form-group">
...
<div class="col-sm-10">
<input type="text" name="altconnum" class="form-control" id="altconnum" value="<?php echo htmlentities($result->AltenateNumber)?>"required="required" autocomplete="off">
</div>
</div>
