...
if(!empty($_POST["classid1"])) 
{
 ...
 while($row=$stmt->fetch(PDO::FETCH_ASSOC))
 {?>
  <p> <?php echo htmlentities($row['SubjectName']); ?><input type="number"  name="marks[]" value="" class="form-control" required="" placeholder="Enter marks out of 30" min="1" max="30" autocomplete="off"></p>
