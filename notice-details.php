...
<html lang="en">
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            <div class="container">
                <a class="navbar-brand" href="index.php">SIM-(Student Information Management System)</a>
...
<?php }} ?>
        ...
        <!-- Footer-->
        <div class="footer"><p style="color:white">Copyright &copy; Student Information Management System 2023</p></div>
    </body>
</html>
